...
dependencies {
    ...
    compileOnly("io.papermc.paper:paper-api:1.20.3-R0.1-SNAPSHOT") { exclude("net.kyori") }
...
bukkit {
    ...
    libraries = listOf("org.springframework:spring-expression:6.0.12", "org.apache.httpcomponents:httpmime:4.5.14", "dev.jorel:commandapi-bukkit-shade:$commandApiVersion", "org.joml:joml:1.10.5")
