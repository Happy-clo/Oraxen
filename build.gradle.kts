...
dependencies {
    ...
    compileOnly("org.springframework:spring-expression:6.1.2")
...
bukkit {
    ...
    libraries = listOf("org.springframework:spring-expression:6.1.2", "org.apache.httpcomponents:httpmime:4.5.14", "dev.jorel:commandapi-bukkit-shade:$commandApiVersion", "org.joml:joml:1.10.5")
